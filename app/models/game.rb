class Game < ApplicationRecord
  ...
  has_one :white_player, class_name: 'User', dependent: false # should this be :white_player_id ?
  has_one :black_player, class_name: 'User', dependent: false # should this be :black_player_id ?
