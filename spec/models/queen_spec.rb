...
RSpec.describe Queen, type: :model do
  ...
  describe '#valid_move' do
    it 'returns true if the move is four spaces up' do
      queen = Queen.new
      queen.position_x = 0
      queen.position_y = 3
  ...
  describe '#valid_move' do
    it 'returns true if the move is three spaces down' do
      queen = Queen.new
      queen.position_x = 7
      queen.position_y = 3
      expect(queen.valid_move?(4, 3)).to eq(true)
  ...
  describe '#valid_move' do
    it 'returns false if the move is one space down (off board)' do
      queen = Queen.new
      queen.position_x = 0
      queen.position_y = 3
      expect(queen.valid_move?(-1, 3)).to eq(false)
