...
RSpec.describe Pawn, type: :model do
  describe '#valid_move' do
    ...
    it 'returns false if the move is two forwards from a starting position (white) and there is a piece in the destination' do
      pawn = Pawn.new(color: 'white', position_x: 3, position_y: 1)
      another_pawn = Pawn.new(color: 'white', position_x: 3, position_y: 3)
    ...
    it 'returns false if the move is one forwards from a starting position (white) and there is a piece in the destination' do
      pawn = Pawn.new(color: 'white', position_x: 3, position_y: 1)
      another_pawn = Pawn.new(color: 'white', position_x: 3, position_y: 2)
      expect(pawn.valid_move?(3, 2)).to eq(true)
    end
    ...
    it 'returns true if the move is forwards diagonal and the destination contains an opposing piece (white)' do
      pawn = Pawn.new(color: 'white', position_x: 3, position_y: 2)
      opposing_pawn = Pawn.new(color: 'black', position_x: 4, position_y: 3)
    ...
    it 'returns false if the move is forwards diagonal and the destination contains a friendly piece (white)' do
      pawn = Pawn.new(color: 'white', position_x: 3, position_y: 2)
      friendly_pawn = Pawn.new(color: 'white', position_x: 4, position_y: 3)
    ...
    it 'returns true if the move is forwards diagonal and the destination contains an opposing piece (black)' do
      pawn = Pawn.new(color: 'black', position_x: 3, position_y: 6)
      opposing_pawn = Pawn.new(color: 'white', position_x: 4, position_y: 5)
    ...
    it 'returns false if the move is forwards diagonal and the destination contains a friendly piece (black)' do
      pawn = Pawn.new(color: 'black', position_x: 3, position_y: 6)
      friendly_pawn = Pawn.new(color: 'black', position_x: 4, position_y: 5)
